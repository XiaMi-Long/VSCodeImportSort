...
class ImportSort {
    ...
    static splitWords(words) {
        ...
        switch (ImportSort.regexType) {
            ...
            case 'import':
                imports = words.match(ImportSort.regex)?.map((item) => {
                    ...
                    return lastLengthStr === '\n' || lastLengthStr === '\r' ? item : item + os_1.default.EOL;
                });
                break;
        }
        if (imports) {
        ...
        /* eslint-disable */ console.log(...oo_oo(`3548882362_64_8_64_43_4`, JSON.stringify(os_1.default.EOL)));
        return ImportSort;
    }
    /**
     * 降序
